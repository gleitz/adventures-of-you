    ...
    return(
      <Layout>
        ...
        <div style={{ background: '#000', color: '#FFF', padding: '40px' }}>
          ...
          <br/>
          <div>
            STEP 2: Next, screenshot your message to them and submit to <a style={{color: '#FFF'}}href="mailto:fear@adventuresofyou.online">fear@adventuresofyou.online</a>. We will respond with the final step! Be brave. Be kind. Be true.
          </div>
          <br/>
        </div>
      </Layout>
