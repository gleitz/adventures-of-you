...
class TakeItBackCaptcha extends React.Component {
  constructor(props) {
    super(props)
    shuffle(ITEMS)
    this.state = {
  ...
  checkImages = () => {
    ...
    if (valid) {
      window.location = "/take-it-back-tickets"
    }
  }
  ...
  render() {
    return (
      <Layout key={this.state.isClient} pageTitle="Take It Back!">
        <SEO title="Take It Back: Emotional Captcha" />
        <h1>Emotional Captcha</h1>
        <div>Humans only beyond this point.</div>
...
export default TakeItBackCaptcha
