    ...
    return (
      <Layout>
        ...
        <div className='padded'>
          ...
          <div>
            While today's party is free, all donations to organizations and funds that support indigenous sovereignty and environmental justice will be matched by May Partay Philanthropists. A few are listed below, but feel free to choose your own.
          </div>
          <div>
            <a target="_blank" href="https://sogoreate-landtrust.org/donate/"><h2>Sogorea Te’ Land Trust</h2></a>
            <p>Sogorea Te' Land Trust is an urban Indigenous women-led land trust that facilitates the return of Indigenous land to Indigenous people.</p>
          </div>
          <div>
