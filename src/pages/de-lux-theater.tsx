...
const DeLuxPage = () => (
  <Layout>
    ...
    <div className='padded'>
      ...
      <div>
Grab your buttery popcorn, Junior Mints, and Raisinets because we're headed to the <b>Shelter Island De Lux</b>, the Bay Area's most exclusive drive-in theater.
      </div>
      <div>
